					...
					<c1:forEach var="product" items="${pro}">
						...
						<div class="products-grd">
							...
							<div class="p-one simpleCart_shelfItem prd">
								...
								<a href="single">
										<img src="${images}/${product.getImage()}" alt="" class="img-responsive" />
										<div class="mask">
											<span>Quick View</span>
										</div>
								</a>
								<h4> ForeEver Diamonds</h4>
								<p><a class="item_add" href="#"><i></i> <span class=" item_price valsa">Rs.${product.getP_price()}</span></a></p>
								<div class="pro-grd">
						...
						<section  class="sky-form">
							...
							<div class="row1 scroll-pane">
								...
								<div class="col col-4">
									...
									<label class="checkbox"><input type="checkbox" name="checkbox" ><i></i>Emeralds</label>
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Diamonds</label>
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Sapphires</label>
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Ruby</label>
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Pearls</label>
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>WhiteMarbles</label>
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>prince</label>
									<label class="checkbox"><input type="checkbox" name="checkbox" ><i></i>mili</label>
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Brownnies</label>
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>topazz</label>
								</div>
							</div>
						</section>
						<section  class="sky-form">
							...
							<div class="row1 scroll-pane">
								<div class="col col-4">
									<label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i></i>Prince</label>
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Davanam</label>
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Malbar</label>
								</div>
								<div class="col col-4">
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>vishnu</label>
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>joyallukas</label>
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>josallukas</label>
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Nakshtra</label>
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>biba</label>
									<label class="checkbox"><input type="checkbox" name="checkbox" ><i></i>shree</label>
									<label class="checkbox"><input type="checkbox" name="checkbox"><i></i>Tanishq</label>																							
								</div>
							</div>
						</section>
					</div>
